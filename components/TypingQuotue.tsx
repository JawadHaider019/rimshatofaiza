...
const TypingQuote: React.FC<TypingQuoteProps> = ({ text, position, delayStart = 0, className = '', onComplete }) => {
  ...
  const containerClasses = position === 'top-right'
    ? 'top-6 right-0 pr-4 sm:pr-8 sm:top-10 sm:right-0 md:top-12 lg:top-16 items-end'
    : 'bottom-6 left-0 pl-4 sm:pl-8 sm:bottom-10 sm:left-0 md:bottom-12 lg:bottom-16 items-start';
